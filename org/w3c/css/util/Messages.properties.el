...
error.counter: Μη έγκυρος ορισμός του προσδιορισμού counter(<identifier>[,<list-style-type>]?)
error.counters: Μη έγκυρος ορισμός του προσδιορισμού counters(<identifier>,<string>[,<list-style-type>]?)

# used by org.w3c.css.font.Src
error.format: Μη έγκυρος προσδιορισμός μορφοποίησης format(<string>[,<string>]*)
...
error.two-lengths: Η μετατόπιση σκιάς (shadow offset) να περιγράφεται με δύο τιμές <length> (μπορεί να προσδιοριστεί προαιρετικά μία ακτίνα blur μετά την μετατόπιση σκιάς (shadow offset).)
...
Παρακαλούμε διορθώστε το αίτημα σας ή στείλτε μήνυμα στο plh@w3.org.
