...
/**
 * @spec http://www.w3.org/TR/2008/REC-CSS2-20080411/aural.html#propdef-play-during
 */
		...
		switch (val.getType()) {
			case CssTypes.CSS_URL:
				...
				if (expression.getRemainingCount() > 1) {
					...
					val = expression.getValue();
					op = expression.getOperator();
					// the grammar says mix? repeat?
					// most probably against what was intended (see CSS21).
