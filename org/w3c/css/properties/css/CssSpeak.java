// $Id: CssSpeak.java,v 1.1 2012-12-18 09:47:59 ylafon Exp $
...
public class CssSpeak extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssSpeak != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssSpeak = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssSpeak &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getSpeak();
        } else {
            return ((Css2Style) style).cssSpeak;
        }
    }
}
