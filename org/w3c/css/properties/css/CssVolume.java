...
public class CssVolume extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssVolume != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssVolume = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssVolume &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getVolume();
        } else {
            return ((Css2Style) style).cssVolume;
        }
    }
}
