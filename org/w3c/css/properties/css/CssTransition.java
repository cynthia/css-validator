// $Id: CssTransition.java,v 1.1 2012-10-04 10:26:20 ylafon Exp $
...
public class CssTransition extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTransition &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTransition();
		} else {
			return ((Css3Style) style).cssTransition;
		}
	}
}
