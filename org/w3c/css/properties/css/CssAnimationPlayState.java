...
public class CssAnimationPlayState extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssAnimationPlayState != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAnimationPlayState &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAnimationPlayState();
		} else {
			return ((Css3Style) style).cssAnimationPlayState;
		}
	}
}
