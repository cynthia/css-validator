// $Id: CssAnimationIterationCount.java,v 1.1 2012-10-08 09:50:50 ylafon Exp $
 ...
 * @since CSS3
 */
public class CssAnimationIterationCount extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssAnimationIterationCount != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAnimationIterationCount &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAnimationIterationCount();
		} else {
			return ((Css3Style) style).cssAnimationIterationCount;
		}
	}
}
