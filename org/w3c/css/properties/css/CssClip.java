// $Id: CssClip.java,v 1.1 2012-11-05 10:36:12 ylafon Exp $
...
public class CssClip extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssClip != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssClip = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getClip();
        } else {
            return ((Css2Style) style).cssClip;
        }
    }
}
