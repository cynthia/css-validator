// $Id: CssRestAfter.java,v 1.1 2013-01-09 09:03:05 ylafon Exp $
...
public class CssRestAfter extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		if (((Css3Style) style).cssRestAfter != null)
			style.addRedefinitionWarning(ac, this);
		((Css3Style) style).cssRestAfter = this;
	}
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssRestAfter &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getRestAfter();
		} else {
			return ((Css3Style) style).cssRestAfter;
		}
	}
}
