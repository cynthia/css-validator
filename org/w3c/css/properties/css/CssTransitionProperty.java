...
public class CssTransitionProperty extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTransitionProperty != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTransitionProperty &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTransitionProperty();
		} else {
			return ((Css3Style) style).cssTransitionProperty;
		}
	}
}
