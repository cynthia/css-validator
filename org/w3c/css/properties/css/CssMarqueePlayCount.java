...
public class CssMarqueePlayCount extends CssProperty {
	...
	/**
	 * Creates a new CssMarqueePlayCount
	 *
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssMarqueePlayCount &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getMarqueePlayCount();
		} else {
			return ((Css3Style) style).cssMarqueePlayCount;
		}
	}
}
