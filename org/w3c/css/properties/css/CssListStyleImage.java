// $Id: CssListStyleImage.java,v 1.1 2012-11-07 11:34:53 ylafon Exp $
...
public class CssListStyleImage extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		if (((Css1Style)style).cssListStyleImage != null) {
			style.addRedefinitionWarning(ac, this);
		}
		((Css1Style)style).cssListStyleImage = this;
	}
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			...
			return ((Css1Style) style).cssListStyleImage;
		}
	}
	...
	public boolean equals(CssProperty property) {
		try {
			CssListStyleImage other = (CssListStyleImage) property;
