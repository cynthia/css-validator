...
public class CssPerspectiveOrigin extends CssProperty {
	 ...
	 */
	public CssPerspectiveOrigin(ApplContext ac, CssExpression expression, boolean check)
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssPerspectiveOrigin != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssPerspectiveOrigin &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getPerspectiveOrigin();
		} else {
			return ((Css3Style) style).cssPerspectiveOrigin;
		}
	}
}
