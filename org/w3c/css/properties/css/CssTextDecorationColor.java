...
public class CssTextDecorationColor extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextDecorationColor != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextDecorationColor &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextDecorationColor();
		} else {
			return ((Css3Style) style).cssTextDecorationColor;
		}
	}
}
