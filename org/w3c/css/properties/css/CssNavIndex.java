// $Id: CssNavIndex.java,v 1.1 2012-10-17 09:29:58 ylafon Exp $
...
public class CssNavIndex extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssNavIndex &&
				value.equals(((CssNavIndex) property).value));
	}
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getNavIndex();
		} else {
