// $Id: CssListStyleType.java,v 1.1 2012-11-07 11:34:54 ylafon Exp $
...
public class CssListStyleType extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		if (((Css1Style)style).cssListStyleType != null) {
			style.addRedefinitionWarning(ac, this);
		}
		((Css1Style)style).cssListStyleType = this;
	}
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			...
			return ((Css1Style) style).cssListStyleType;
		}
	}
	...
	public boolean equals(CssProperty property) {
		try {
			CssListStyleType other = (CssListStyleType) property;
