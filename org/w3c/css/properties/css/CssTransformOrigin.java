...
public class CssTransformOrigin extends CssProperty {
	 ...
	 */
	public CssTransformOrigin(ApplContext ac, CssExpression expression, boolean check)
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTransformOrigin &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTransformOrigin();
		} else {
			return ((Css3Style) style).cssTransformOrigin;
		}
	}
}
