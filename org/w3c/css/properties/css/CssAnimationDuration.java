// $Id: CssAnimationDuration.java,v 1.1 2012-10-08 08:46:51 ylafon Exp $
...
public class CssAnimationDuration extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssAnimationDuration != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAnimationDuration &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAnimationDuration();
		} else {
			return ((Css3Style) style).cssAnimationDuration;
		}
	}
}
