// $Id: CssCounterReset.java,v 1.1 2012-11-06 11:22:00 ylafon Exp $
...
public class CssCounterReset extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssCounterReset != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssCounterReset = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssCounterReset &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getCounterReset();
        } else {
            return ((Css2Style) style).cssCounterReset;
        }
    }
}
