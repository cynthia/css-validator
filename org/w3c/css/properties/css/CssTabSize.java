// $Id: CssTabSize.java,v 1.1 2012-08-31 14:04:18 ylafon Exp $
...
public class CssTabSize extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTabSize &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTabSize();
		} else {
			return ((Css3Style) style).cssTabSize;
		}
	}
}
