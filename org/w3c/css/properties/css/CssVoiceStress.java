// $Id: CssVoiceStress.java,v 1.1 2013-01-04 15:14:44 ylafon Exp $
...
public class CssVoiceStress extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssVoiceStress &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getVoiceStress();
		} else {
			return ((Css3Style) style).cssVoiceStress;
		}
	}
}
