// $Id: CssPaddingRight.java,v 1.2 2012-09-25 20:01:36 ylafon Exp $
...
public class CssPaddingRight extends CssProperty {
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			...
			return ((Css1Style) style).cssPadding.paddingRight;
		}
	}
	...
	public boolean equals(CssProperty property) {
		try {
			CssPaddingRight other = (CssPaddingRight) property;
