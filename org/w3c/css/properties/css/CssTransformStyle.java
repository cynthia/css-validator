// $Id: CssTransformStyle.java,v 1.1 2012-10-12 08:48:56 ylafon Exp $
...
public class CssTransformStyle extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTransformStyle &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTransformStyle();
		} else {
			return ((Css3Style) style).cssTransformStyle;
		}
	}
}
