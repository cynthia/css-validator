...
public class CssTextUnderlinePosition extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextUnderlinePosition != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextUnderlinePosition &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextUnderlinePosition();
		} else {
			return ((Css3Style) style).cssTextUnderlinePosition;
		}
	}
}
