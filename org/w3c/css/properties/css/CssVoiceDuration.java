// $Id: CssVoiceDuration.java,v 1.1 2013-01-04 15:24:38 ylafon Exp $
...
public class CssVoiceDuration extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssVoiceDuration &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getVoiceDuration();
		} else {
			return ((Css3Style) style).cssVoiceDuration;
		}
	}
}
