...
public class CssTextDecorationStyle extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextDecorationStyle != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextDecorationStyle &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextDecorationStyle();
		} else {
			return ((Css3Style) style).cssTextDecorationStyle;
		}
	}
}
