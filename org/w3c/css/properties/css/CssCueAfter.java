// $Id: CssCueAfter.java,v 1.1 2013-01-03 14:57:08 ylafon Exp $
 ...
 * @since CSS2
 */
public class CssCueAfter extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssCueAfter != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssCueAfter = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getCueAfter();
        } else {
            return ((Css2Style) style).cssCueAfter;
        }
    }
}
