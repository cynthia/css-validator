// $Id: CssVoiceRate.java,v 1.1 2013-01-08 13:30:13 ylafon Exp $
...
public class CssVoiceRate extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssVoiceRate &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getVoiceRate();
		} else {
			return ((Css3Style) style).cssVoiceRate;
		}
	}
}
