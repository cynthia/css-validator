// $Id: CssStress.java,v 1.1 2013-01-02 13:32:29 ylafon Exp $
...
public class CssStress extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssStress != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssStress = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssStress &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getStress();
        } else {
            return ((Css2Style) style).cssStress;
        }
    }
}
