// $Id: CssFontSynthesis.java,v 1.1 2012-08-08 21:05:39 ylafon Exp $
...
public class CssFontSynthesis extends CssProperty {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssFontSynthesis &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getFontSynthesis();
		} else {
			return ((Css3Style) style).cssFontSynthesis;
		}
    }
}
