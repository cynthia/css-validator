// $Id: CssPitch.java,v 1.1 2013-01-04 11:07:24 ylafon Exp $
...
public class CssPitch extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssPitch != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssPitch = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssPitch &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getPitch();
        } else {
            return ((Css2Style) style).cssPitch;
        }
    }
}
