...
public class CssTextEmphasisPosition extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextEmphasisPosition != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextEmphasisPosition &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextEmphasisPosition();
		} else {
			return ((Css3Style) style).cssTextEmphasisPosition;
		}
	}
}
