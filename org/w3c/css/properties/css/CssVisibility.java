// $Id: CssVisibility.java,v 1.1 2012-11-05 15:35:24 ylafon Exp $
...
public class CssVisibility extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		if (((Css2Style) style).cssVisibility != null)
			style.addRedefinitionWarning(ac, this);
		((Css2Style) style).cssVisibility = this;
	}
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css2Style) style).getVisibility();
		} else {
			return ((Css2Style) style).cssVisibility;
		}
	}
}
