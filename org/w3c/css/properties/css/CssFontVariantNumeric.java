// $Id: CssFontVariantNumeric.java,v 1.1 2012-08-10 05:02:12 ylafon Exp $
...
public class CssFontVariantNumeric extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssFontVariantNumeric != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssFontVariantNumeric &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getFontVariantNumeric();
		} else {
			return ((Css3Style) style).cssFontVariantNumeric;
		}
    }
}
