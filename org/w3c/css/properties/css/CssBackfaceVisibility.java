// $Id: CssBackfaceVisibility.java,v 1.1 2012-10-12 08:48:34 ylafon Exp $
 ...
 * @since CSS3
 */
public class CssBackfaceVisibility extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssBackfaceVisibility != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssBackfaceVisibility &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getBackfaceVisibility();
		} else {
			return ((Css3Style) style).cssBackfaceVisibility;
		}
	}
}
