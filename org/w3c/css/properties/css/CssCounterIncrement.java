// $Id: CssCounterIncrement.java,v 1.1 2012-11-06 09:49:48 ylafon Exp $
...
public class CssCounterIncrement extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssCounterIncrement != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssCounterIncrement = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssCounterIncrement &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getCounterIncrement();
        } else {
            return ((Css2Style) style).cssCounterIncrement;
        }
    }
}
