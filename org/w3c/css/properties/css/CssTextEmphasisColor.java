...
public class CssTextEmphasisColor extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextEmphasisColor != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextEmphasisColor &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextEmphasisColor();
		} else {
			return ((Css3Style) style).cssTextEmphasisColor;
		}
	}
}
