// $Id: CssMaxWidth.java,v 1.1 2012-10-11 12:36:13 ylafon Exp $
...
public class CssMaxWidth extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssMaxWidth != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssMaxWidth = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getMaxWidth();
        } else {
            return ((Css2Style) style).cssMaxWidth;
        }
    }
}
