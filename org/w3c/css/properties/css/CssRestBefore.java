// $Id: CssRestBefore.java,v 1.1 2013-01-09 09:06:29 ylafon Exp $
...
public class CssRestBefore extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		if (((Css3Style) style).cssRestBefore != null)
			style.addRedefinitionWarning(ac, this);
		((Css3Style) style).cssRestBefore = this;
	}
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssRestBefore &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getRestBefore();
		} else {
			return ((Css3Style) style).cssRestBefore;
		}
	}
}
