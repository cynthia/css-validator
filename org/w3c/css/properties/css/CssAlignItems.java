// $Id: CssAlignItems.java,v 1.1 2012-10-07 10:41:50 ylafon Exp $
...
public class CssAlignItems extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAlignItems &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAlignItems();
		} else {
			return ((Css3Style) style).cssAlignItems;
		}
	}
}
