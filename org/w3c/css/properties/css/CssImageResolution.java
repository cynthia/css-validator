// $Id: CssImageResolution.java,v 1.1 2012-11-28 15:58:54 ylafon Exp $
...
public class CssImageResolution extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssImageResolution &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getImageResolution();
		} else {
			return ((Css3Style) style).cssImageResolution;
		}
	}
}
