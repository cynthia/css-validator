// $Id: CssFlexGrow.java,v 1.1 2012-10-07 13:12:17 ylafon Exp $
...
public class CssFlexGrow extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssFlexGrow &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getFlexGrow();
		} else {
			return ((Css3Style) style).cssFlexGrow;
		}
	}
}
