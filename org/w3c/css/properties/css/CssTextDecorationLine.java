...
public class CssTextDecorationLine extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextDecorationLine != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextDecorationLine &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextDecorationLine();
		} else {
			return ((Css3Style) style).cssTextDecorationLine;
		}
	}
}
