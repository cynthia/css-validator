// $Id: CssAlignContent.java,v 1.1 2012-10-07 10:41:50 ylafon Exp $
...
public class CssAlignContent extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAlignContent &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAlignContent();
		} else {
			return ((Css3Style) style).cssAlignContent;
		}
	}
}
