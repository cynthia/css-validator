// $Id: CssBottom.java,v 1.1 2012-09-27 14:57:30 ylafon Exp $
 ...
 * @since CSS2
 */
public class CssBottom extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssBottom != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssBottom = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getBottom();
        } else {
            return ((Css2Style) style).cssBottom;
        }
    }
}
