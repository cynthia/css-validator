// $Id: CssFontVariant.java,v 1.1 2012-08-04 21:17:05 ylafon Exp $
...
/**
 * @spec http://www.w3.org/TR/2008/REC-CSS2-20080411/fonts.html#propdef-font-variant
 */
	...
	public CssFontVariant(ApplContext ac, CssExpression expression, boolean check)
		...
		if (val.getType() == CssTypes.CSS_IDENT) {
			...
			if (inherit.equals(ident)) {
				value = inherit;
			} else if (smallCaps.equals(ident)) {
				value = smallCaps;
