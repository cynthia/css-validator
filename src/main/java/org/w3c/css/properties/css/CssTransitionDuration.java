// $Id: CssTransitionDuration.java,v 1.1 2012-10-03 09:49:17 ylafon Exp $
...
public class CssTransitionDuration extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTransitionDuration != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTransitionDuration &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTransitionDuration();
		} else {
			return ((Css3Style) style).cssTransitionDuration;
		}
	}
}
