// $Id: CssImeMode.java,v 1.1 2012-10-17 08:16:24 ylafon Exp $
...
public class CssImeMode extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssImeMode &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getImeMode();
		} else {
			return ((Css3Style) style).cssImeMode;
		}
	}
}
