// $Id: CssObjectPosition.java,v 1.1 2012-11-28 09:28:10 ylafon Exp $
...
public class CssObjectPosition extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssObjectPosition &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getObjectPosition();
		} else {
			return ((Css3Style) style).cssObjectPosition;
		}
	}
}
