...
public class CssTextEmphasisStyle extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextEmphasisStyle != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextEmphasisStyle &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextEmphasisStyle();
		} else {
			return ((Css3Style) style).cssTextEmphasisStyle;
		}
	}
}
