// $Id: CssObjectFit.java,v 1.1 2012-11-28 09:18:17 ylafon Exp $
...
public class CssObjectFit extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssObjectFit &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getObjectFit();
		} else {
			return ((Css3Style) style).cssObjectFit;
		}
	}
}
