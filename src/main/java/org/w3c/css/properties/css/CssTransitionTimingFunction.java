...
public class CssTransitionTimingFunction extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTransitionTimingFunction != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTransitionTimingFunction &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTransitionTimingFunction();
		} else {
			return ((Css3Style) style).cssTransitionTimingFunction;
		}
	}
}
