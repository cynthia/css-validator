// $Id: CssPitchRange.java,v 1.1 2013-01-02 13:48:14 ylafon Exp $
...
public class CssPitchRange extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssPitchRange != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssPitchRange = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getPitchRange();
        } else {
            return ((Css2Style) style).cssPitchRange;
        }
    }
}
