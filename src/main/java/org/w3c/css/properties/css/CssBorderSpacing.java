// $Id: CssBorderSpacing.java,v 1.1 2012-12-06 18:58:13 ylafon Exp $
 ...
 */
public class CssBorderSpacing extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssBorderSpacing != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssBorderSpacing = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssBorderSpacing &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            ...
            return ((Css2Style) style).cssBorderSpacing;
        }
    }
}
