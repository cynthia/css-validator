// $Id: CssSpeechRate.java,v 1.1 2012-12-21 15:55:47 ylafon Exp $
...
public class CssSpeechRate extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssSpeechRate != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssSpeechRate = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssSpeechRate &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getSpeechRate();
        } else {
            return ((Css2Style) style).cssSpeechRate;
        }
    }
}
