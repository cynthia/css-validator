// $Id: CssOverflowWrap.java,v 1.1 2012-08-30 12:26:44 ylafon Exp $
...
public class CssOverflowWrap extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssOverflowWrap &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getOverflowWrap();
		} else {
			return ((Css3Style) style).cssOverflowWrap;
		}
	}
}
