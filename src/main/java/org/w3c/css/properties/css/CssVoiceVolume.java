// $Id: CssVoiceVolume.java,v 1.1 2013-01-08 14:46:18 ylafon Exp $
...
public class CssVoiceVolume extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssVoiceVolume &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getVoiceVolume();
		} else {
			return ((Css3Style) style).cssVoiceVolume;
		}
	}
}
