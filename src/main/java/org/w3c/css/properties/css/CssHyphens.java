// $Id: CssHyphens.java,v 1.1 2012-08-30 13:10:28 ylafon Exp $
...
public class CssHyphens extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssHyphens &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getHyphens();
		} else {
			return ((Css3Style) style).cssHyphens;
		}
	}
}
