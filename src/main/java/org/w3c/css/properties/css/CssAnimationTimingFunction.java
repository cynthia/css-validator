 ...
 * @since CSS3
 */
public class CssAnimationTimingFunction extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssAnimationTimingFunction != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAnimationTimingFunction &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAnimationTimingFunction();
		} else {
			return ((Css3Style) style).cssAnimationTimingFunction;
		}
	}
}
