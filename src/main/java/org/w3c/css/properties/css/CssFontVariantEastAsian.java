// $Id: CssFontVariantEastAsian.java,v 1.1 2012-08-09 08:47:44 ylafon Exp $
...
public class CssFontVariantEastAsian extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssFontVariantEastAsian != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssFontVariantEastAsian &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getFontVariantEastAsian();
		} else {
			return ((Css3Style) style).cssFontVariantEastAsian;
		}
    }
}
