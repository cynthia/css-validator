// $Id: CssAnimationFillMode.java,v 1.1 2012-10-08 09:27:30 ylafon Exp $
 ...
 * @since CSS3
 */
public class CssAnimationFillMode extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssAnimationFillMode != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAnimationFillMode &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAnimationFillMode();
		} else {
			return ((Css3Style) style).cssAnimationFillMode;
		}
	}
}
