// $Id: CssOrder.java,v 1.1 2012-10-07 13:37:28 ylafon Exp $
...
public class CssOrder extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssOrder &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getOrder();
		} else {
			return ((Css3Style) style).cssOrder;
		}
	}
}
