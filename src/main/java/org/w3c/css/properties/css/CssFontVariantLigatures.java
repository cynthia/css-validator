...
public class CssFontVariantLigatures extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssFontVariantLigatures != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssFontVariantLigatures &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getFontVariantLigatures();
		} else {
			return ((Css3Style) style).cssFontVariantLigatures;
		}
    }
}
