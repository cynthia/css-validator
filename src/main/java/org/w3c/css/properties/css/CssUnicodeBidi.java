// $Id: CssUnicodeBidi.java,v 1.1 2012-11-05 14:25:59 ylafon Exp $
...
public class CssUnicodeBidi extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssUnicodeBidi != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssUnicodeBidi = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getUnicodeBidi();
        } else {
            return ((Css2Style) style).cssUnicodeBidi;
        }
    }
}
