...
public class CssTextDecorationSkip extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssTextDecorationSkip != null) {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssTextDecorationSkip &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getTextDecorationSkip();
		} else {
			return ((Css3Style) style).cssTextDecorationSkip;
		}
	}
}
