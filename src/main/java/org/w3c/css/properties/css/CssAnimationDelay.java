// $Id: CssAnimationDelay.java,v 1.1 2012-10-08 08:31:31 ylafon Exp $
...
public class CssAnimationDelay extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssAnimationDelay &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getAnimationDelay();
		} else {
			return ((Css3Style) style).cssAnimationDelay;
		}
	}
}
