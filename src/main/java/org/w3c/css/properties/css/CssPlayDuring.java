// $Id: CssPlayDuring.java,v 1.1 2013-01-06 21:06:48 ylafon Exp $
...
public class CssPlayDuring extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssPlayDuring != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssPlayDuring = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssPlayDuring &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getPlayDuring();
        } else {
            return ((Css2Style) style).cssPlayDuring;
        }
    }
}
