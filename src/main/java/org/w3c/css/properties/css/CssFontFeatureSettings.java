...
public class CssFontFeatureSettings extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
		...
		if (s.cssFontFeatureSettings != null) {
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssFontFeatureSettings &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getFontFeatureSettings();
		} else {
			return ((Css3Style) style).cssFontFeatureSettings;
		}
    }
}
