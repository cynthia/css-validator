// $Id: CssFlexWrap.java,v 1.1 2012-10-07 12:16:46 ylafon Exp $
...
public class CssFlexWrap extends CssProperty {
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssFlexWrap &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getFlexWrap();
		} else {
			return ((Css3Style) style).cssFlexWrap;
		}
	}
}
