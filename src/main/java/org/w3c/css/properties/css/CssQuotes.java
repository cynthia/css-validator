// $Id: CssQuotes.java,v 1.1 2012-11-05 21:46:49 ylafon Exp $
...
public class CssQuotes extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssQuotes != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssQuotes = this;
    }
    ...
    public boolean equals(CssProperty property) {
        return (property instanceof CssQuotes &&
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getQuotes();
        } else {
            return ((Css2Style) style).cssQuotes;
        }
    }
}
