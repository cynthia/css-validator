// $Id: CssSpeakAs.java,v 1.1 2013-01-10 11:34:20 ylafon Exp $
...
public class CssSpeakAs extends CssProperty {
	...
	public void addToStyle(ApplContext ac, CssStyle style) {
		if (((Css3Style) style).cssSpeakAs != null)
			style.addRedefinitionWarning(ac, this);
		((Css3Style) style).cssSpeakAs = this;
	}
	...
	public boolean equals(CssProperty property) {
		return (property instanceof CssSpeakAs &&
	...
	public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
		if (resolve) {
			return ((Css3Style) style).getSpeakAs();
		} else {
			return ((Css3Style) style).cssSpeakAs;
		}
	}
}
