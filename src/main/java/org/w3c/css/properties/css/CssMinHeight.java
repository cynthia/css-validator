// $Id: CssMinHeight.java,v 1.2 2012-10-11 13:33:59 ylafon Exp $
...
public class CssMinHeight extends CssProperty {
    ...
    public void addToStyle(ApplContext ac, CssStyle style) {
        if (((Css2Style) style).cssMinHeight != null)
            style.addRedefinitionWarning(ac, this);
        ((Css2Style) style).cssMinHeight = this;
    }
    ...
    public CssProperty getPropertyInStyle(CssStyle style, boolean resolve) {
        if (resolve) {
            return ((Css2Style) style).getMinHeight();
        } else {
            return ((Css2Style) style).cssMinHeight;
        }
    }
}
